      ...
      <div className="side-menu col-1">
        <div classname="row"><button onClick={showMenu}><i class="fas fa-times"></i></button></div>
          <div className="row menu-link">
            <a  id="about-me-link" href="#about-section"><button class="link-button">About</button></a>
          </div>
          <div className="row menu-link">
            <a id="projects-link" href="#projects"><button class="link-button">Projects</button></a>
          </div>
          <div className="row menu-link"><a id="contact-link" href="#contact"><button class="link-button">Contact</button></a></div>
